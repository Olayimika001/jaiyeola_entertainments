        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div>
            ...
            <p className="font-small text-[#C8C8C8] mb-1">
             ...
             <p className="font-small text-[#C8C8C8] mb-1">
              <a href="tel:+2348026245050" className="hover:text-white transition-colors"> +2348026245055</a>
            </p>
             <p className="font-small text-[#C8C8C8] mb-1">
              <a href="mailto:monsuruobadinafala@gmail.com" className="hover:text-white transition-colors">Info@jaiyeolamovieentertaimentproductions.net</a>
            </p>
            <p className="font-small text-[#C8C8C8] mb-1">
